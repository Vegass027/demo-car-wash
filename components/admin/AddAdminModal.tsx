...
interface AddAdminModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (admin: { name: string; phone: string; cardDetails?: string; paymentPhone?: string; paymentComment?: string }) => void;
}
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] max-h-[90vh] overflow-y-auto scroll-mobile">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="admin-card">Реквизиты карты для ЗП</Label>
            <Input
              id="admin-card"
          ...
          <div className="space-y-2">
            <Label htmlFor="admin-payment-phone">Телефон для переводов</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="admin-payment-comment">Комментарий для перевода</Label>
            <Input
              id="admin-payment-comment"
