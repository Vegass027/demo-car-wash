...
interface AddWorkerModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (worker: { name: string; phone: string; cardDetails?: string; paymentPhone?: string; paymentComment?: string }) => void;
}
      ...
      <DialogContent className="sm:max-w-[425px] max-h-[90vh] overflow-y-auto scroll-mobile">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="space-y-2">
            ...
            <Input
              id="worker-name"
              placeholder="Введите имя мойщика"
              value={name}
          ...
          <div className="space-y-2">
            <Label htmlFor="worker-card">Реквизиты карты для ЗП</Label>
            <Input
              id="worker-card"
          ...
          <div className="space-y-2">
            <Label htmlFor="worker-payment-phone">Телефон для переводов</Label>
            <Input
              id="worker-payment-phone"
              placeholder="+7 (___) ___-__-__"
              value={paymentPhone}
          ...
          <div className="space-y-2">
            <Label htmlFor="worker-payment-comment">Комментарий для перевода</Label>
            <Input
              id="worker-payment-comment"
