...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'База клиентов с историей визитов — кому звонить перед сезоном.',
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'Выручка по направлениям (мойка, шиномонтаж, товары) и по способам оплаты (нал, перевод, безнал, ведомости).',
      'Зарплаты по сотрудникам — автоматически, по факту закрытия заказов.',
      'Документы для юрлиц — ведомость, акт, счёт-фактура в PDF с подписью водителя.',
      'Архив ежедневных отчётов и выбор любого периода.',
    ],
    problem: 'Час на подсчёт кассы вечером, ещё полтора — на акты для юрлиц утром в Excel.',
    solution:
      'Сводка уже посчитана — выручка, зарплаты, расходы, чистая прибыль на одном экране. PDF с подписью водителя для бухгалтерии генерируется в один клик.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Сезонное хранение резины как отдельный заработок для шиномонтажников.',
  ...
  },
  {
    ...
    intro:
      'Вся финансовая картина в одном экране. Сколько заработали, сколько потратили, что осталось. Любой период.',
    bullets: [
      'Выручка по дням, сотрудникам, услугам — точные цифры вместо «мне кажется».',
      '7 аналитических отчётов прямо в Telegram-боте: кто в смене, записи, выручка, ТОП-3 услуг, загрузка по дням, эффективность сотрудников, скорость мойки.',
      'Выбор любого периода в Mini App: день, неделя, месяц, произвольный диапазон дат.',
      'Правка расходов и отчёты по юрлицам — сколько приезжали, на какую сумму.',
      'Архив ежедневных отчётов с выгрузкой PDF и DOCX.',
    ],
    problem: 'Бизнес вроде идёт, но нет ответа, в плюсе вы или нет, кто из сотрудников реально приносит деньги.',
    solution:
      'ТОП-3 сотрудников по выручке, отчёты по дням, отчёты по юрлицам — решения на основе цифр, а не интуиции.',
